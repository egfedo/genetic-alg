...
class Solver:
    ...
    def algorithm(self):
        ...
        global answer
        best_solutions = [None] * self.count_gener
        best_weights = [None] * self.count_gener
        ...
        for i in range(self.count_gener):
            ...
            best_weights[i] = tuple(map(self.tree_weight, best_solutions[i]))
        ...
        return best_solutions, best_weights
